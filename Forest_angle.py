...
def main():
    ...
    # Load data
    data_name = ["Forest"]  # descriptive name
    data_array = [dat.reduce_data(dat.load_data_forest(), 6)]
    ...
    for which_stateprep in range(len(stateprep_array)):
        ...
        for which_data in range(len(data_array)):
            ...
            for i in range(range_layers):
                ...
                with open("./Forest/" + data_name[which_data] + stateprep_name[which_stateprep] + "Layer" + str(
                        n_layers) + ".csv", "w") as f:
                    write = csv.writer(f)
            ...
            with open("./Forest/" + data_name[which_data] + stateprep_name[which_stateprep] + ".csv", "w") as f:
                write = csv.writer(f)
